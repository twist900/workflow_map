...
public class Work implements Serializable {
    ...
    private ArrayList<WorkRelation> workRelations;
    ...
    public ArrayList<WorkRelation> getWorkRelations(){
        return this.workRelations;
    }

    public void setWorkRelations(ArrayList<WorkRelation> workRelations){
        this.workRelations = workRelations;
    }

    public void addWorkRelation(WorkRelation workRelation){
